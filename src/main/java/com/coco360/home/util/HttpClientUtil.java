...
public class HttpClientUtil {
    ...
    public static String doGet(String url, Map<String, String> param, String openid) throws Exception {
...
//        httpPost.setHeader("Content-type", "application/x-www-form-urlencoded");
    ...
    public static String doPost(String url, String param, String openid) throws Exception {
        // 创建Httpclient对象
